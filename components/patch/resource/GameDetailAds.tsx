...
const GAME_DETAIL_ADS_DATA: AdItem[] = [
  {
    ...
    title: '',
    description: '',
    image: 'https://r2.sakinori.top/%E9%A3%8E%E6%9C%88AI/1200x200GIF-ezgif.com-resize-2.gif', // 游戏详情页专用广告图片
    link: 'https://fengyueai.fun?ref_id=88f10d5a-aa3a-47a1-b850-94927bf7ba2f' // 游戏详情页专用广告链接
  },
  {
    id: 'redirect-ad3', //null
    title: '',
    description: '',
    image: 'https://r2.sakinori.top/%E5%8D%83%E9%80%9F%E5%96%B5/qsm.jpg',//https://r2.sakinori.top/1200x200.png
  ...
  },
  {
    ...
    link: 'https://sch.isco5.com?platId=7&channel=7018' // 游戏详情页专用广告链接
  }
]
